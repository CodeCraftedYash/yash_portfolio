...
const Button:React.FC<btnType> = ({text,cb,customClass,Icon}) => {
    const baseClass = customClass? customClass : "bg-[var(--color-accent)] px-2 py-3 rounded-2xl text-white flex flex-nowrap items-center gap-1 py hover:cursor-pointer hover:scale-110 transition-all duration-175 h-fit";
  return (
